ServerEvents.recipes((event) => {
  ...
  event.recipes.ars_nouveau.enchanting_apparatus(
    ['malum:cthonic_gold', 'hazennstuff:deus_essence', 'malum:cthonic_gold', 'hazennstuff:deus_essence', 'malum:cthonic_gold', 'hazennstuff:deus_essence', 'malum:cthonic_gold', 'hazennstuff:deus_essence'],
  ...
  event.recipes.ars_nouveau.enchanting_apparatus(['hazennstuff:nether_star_fragment', 'hazennstuff:nether_star_fragment'], 'hazennstuff:raw_zenalite', 'hazennstuff:starkissed_zenalite', 20000);
