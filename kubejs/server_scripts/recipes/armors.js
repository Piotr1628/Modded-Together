ServerEvents.recipes((event) => {
  event.recipes.malum.spirit_infusion(
    ...
    [
      ...
      "4x hazennstuff:zenalite_ingot",
      "4x irons_spellbooks:mithril_weave",
      "crystal_chronicles:divinite_shard",
      "4x mythsandlegends:possessed_armor_fragment",
    ],
  );
  event.recipes.malum.spirit_infusion(
  ...
  event.recipes.malum.spirit_infusion(
    ...
    [
      ...
      "4x irons_spellbooks:mithril_weave",
      "crystal_chronicles:divinite_shard",
      "4x royalvariations:royal_armor_fragments",
    ],
  );
  event.recipes.malum.spirit_infusion(
    "irons_spellbooks:priest_chestplate",
  ...
  event.recipes.malum.spirit_infusion(
    ...
    [
      ...
      "3x eternal_starlight:deepsilver_ingot",
      "16x create:sturdy_sheet",
      "32x eternal_starlight:thermal_springstone_ingot",
      "2x eternal_starlight:red_starlight_crystal_shard",
    ],
  );
  event.recipes.malum.spirit_infusion(
  ...
  event.recipes.malum.spirit_infusion(
    ...
    [
      ...
      "3x eternal_starlight:deepsilver_ingot",
      "16x create:sturdy_sheet",
      "32x eternal_starlight:glacite_shard",
      "4x cataclysm:cursed_eye",
    ],
  );
  event.recipes.malum.spirit_infusion(
