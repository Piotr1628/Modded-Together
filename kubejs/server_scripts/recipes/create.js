ServerEvents.recipes((event) => {
  event.remove({ id: ['create:item_application/railway_casing'], output: ['minecraft:suspicious_sand'] });
  event.remove({ id: ['sophisticatedstorage:controller', 'refinedstorage:machine_casing'] });
  event.recipes.create.item_application('create:railway_casing', ['minecraft:deepslate', 'unify:gold_sheet']);
  event.recipes.create.item_application('sophisticatedstorage:controller', ['create:andesite_casing', 'sophisticatedstorage:basic_tier_upgrade']);
